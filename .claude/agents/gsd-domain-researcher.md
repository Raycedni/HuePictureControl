...
<required_reading>
Read `C:/Users/Lukas/IdeaProjects/HuePictureControl/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
