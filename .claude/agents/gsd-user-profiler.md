...
<reference>
@C:/Users/Lukas/IdeaProjects/HuePictureControl/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/Lukas/IdeaProjects/HuePictureControl/.claude/get-shit-done/references/user-profiling.md` to load:
