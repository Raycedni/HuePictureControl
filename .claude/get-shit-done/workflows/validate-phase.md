...
```
Task(
  prompt="Read C:/Users/Lukas/IdeaProjects/HuePictureControl/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Lukas/IdeaProjects/HuePictureControl/.claude/get-shit-done/templates/VALIDATION.md`
